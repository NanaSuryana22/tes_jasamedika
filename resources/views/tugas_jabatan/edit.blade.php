...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Tugas Jabatan</h3>
            <p class="text-subtitle text-muted">Edit Data Tugas Jabatan.</p>
        </div>
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('tugas_jabatan.index') }}">Tugas Jabatan</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Data Tugas Jabatan</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" action="{{ route('tugas_jabatan.update', $tugasJabatan->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nama_tugas" class="form-control @error('nama_tugas') is-invalid @enderror"
                                                        placeholder="Silahkan Isi nama_tugas Jabatan.." name="nama_tugas" value="{{ $tugasJabatan->nama_tugas }}" required>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <input type="number" id="bobot_penilaian" class="form-control @error('bobot_penilaian') is-invalid @enderror"
                                                      placeholder="Silahkan Isi Bobot penilaian.." name="bobot_penilaian" value="{{ $tugasJabatan->bobot_penilaian }}" required>
