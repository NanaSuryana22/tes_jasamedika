                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                              <div class="form-group">
                                                ...
                                                <select name="pegawai_id" id="pegawai_id" class="form-control @error('pegawai_id') is-invalid @enderror" value="{{ old('pegawai_id') }}">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <select name="tugas_jabatan_id" id="tugas_jabatan_id" class="form-control @error('tugas_jabatan_id') is-invalid @enderror" value="{{ old('tugas_jabatan_id') }}">
