...
<div class="page-title">
		<div class="row">
				<div class="col-12 col-md-6 order-md-1 order-last">
						<h3>Jabatan</h3>
						<p class="text-subtitle text-muted">Edit Data Jabatan.</p>
				</div>
										...
										<div class="col-12">
												<div class="card">
														<div class="card-content">
																<div class="card-body">
																		<form class="form" action="{{ route('jabatan.update', $jabatan->id) }}" method="post" enctype="multipart/form-data">
																						...
																						<div class="col-md-12 col-12">
																								<div class="form-group">
																										...
																										<input type="text" id="nama" class="form-control @error('nama') is-invalid @enderror"
																												placeholder="Silahkan Isi Nama Jabatan.." name="nama" value="{!! $jabatan->nama !!}" required>
																										@if($errors->has('nama'))
																								...
																								<div class="form-group">
																									...
																									<textarea name="keterangan" id="keterangan" class="form-control" required>{{ $jabatan->keterangan }}</textarea>
